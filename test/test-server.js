...
/*
You use the chai.use function to tell Chai to use the Chai http plugin
and that you should also call the chai.should function.
*/

/*
Write tests for all of your code;

Write a test for all of your methods
